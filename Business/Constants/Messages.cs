...
public static class Messages
{
    public static class Role
    {
        ...
        public static string AlreadyExists = "Role already exists.";
        public static string Created = "Role created successfully.";
        public static string FailedCreate = "Failed to create role.";
        public static string FailedToAddClaims = "Failed to add claims to the role.";
        public static string NotFound = "Role not found.";
        public static string UpdatedSuccessfully = "Role claims updated successfully.";
    }
}
